...
//           <Link
//             to="/career"
//             className="bg-[hsl(357,77%,51%)] text-black px-5 py-2 rounded-full font-bold hover:bg-red-600 hover:text-white transition duration-300 shadow-lg"
//           >
//             Radiologist Registration
//           </Link>
//         </li>

//         {/* ✅ Client Registration Button - Updated Route */}
//         <li className="mx-2 cursor-pointer flex items-center">
//           <Link
...
//             to="/career"
//             onClick={handleNav}
//             className="bg-[hsl(357,77%,51%)] text-black px-5 py-2 rounded-full font-bold hover:bg-red-600 hover:text-white transition duration-300 shadow-lg text-center"
//           >
//             Radiologist Registration
//           </Link>
