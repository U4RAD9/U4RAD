...
// //           Contact
// //         </li>
// //         <li className="p-4 border-b font-bold hover:text-[hsl(357,100%,59%)] cursor-pointer">
// //           <a
// //             href="https://docs.google.com/forms/d/e/1FAIpQLScTov8gEW0wq0o8LJdR275fh2muiDkhnXfzkdey3Gj1VNp9Bw/viewform?usp=sf_link"
// //             target="_blank"
// //             rel="noopener noreferrer"
...
// //         {/* Mobile Buttons */}
// //         <li className="p-4 flex flex-col gap-4 mt-4">
// //           <Link
// //             to="/career"
// //             onClick={handleNav}
// //             className="bg-[hsl(357,100%,59%)] text-white px-5 py-2 rounded-full font-bold hover:bg-red-700 transition duration-300 shadow-lg text-center"
// //           >
// //             Radiologist Registration
// //           </Link>
...
//         {/* ✅ POCT / XraiDigital Button with Tooltip Below (Desktop) */}
//         <li className="relative group mx-1 cursor-pointer flex items-center">
//           <a
//             href="https://www.xraidigital.com/"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="bg-blue-600 text-white px-4 py-2 text-sm rounded-full font-bold hover:bg-blue-700 transition duration-300 shadow-lg whitespace-nowrap"
//           >
//             XRAi Digital
//           </a>
//           {/* Tooltip */}
//           <span className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-xs font-semibold px-3 py-1 rounded shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
//             Point of care Testing & TB testing
//           </span>
//         </li>
//       </ul>
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="bg-blue-600 text-white px-4 py-2 text-sm rounded-full font-bold hover:bg-blue-700 transition duration-300 shadow-lg block text-center"
//             >
//               🚀 XRAi Digital
//             </a>
//             <p className="text-blue-600 text-xs text-center mt-1 font-semibold">
//               Point of Care Testing
//             </p>
//           </div>
//         </li>
